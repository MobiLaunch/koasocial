...
import { ArrowLeft, Moon, Sun, Bell, Shield, User, LogOut, Trash2, Settings as SettingsIcon, Info, FileText, Lock } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const toggleTheme = () => {
    ...
    localStorage.setItem('koa-theme', !isDark ? 'dark' : 'light');
  };
        ...
        <div className="p-5 space-y-5 max-w-2xl mx-auto">
          ...
          <Card className="rounded-3xl border-0 koa-shadow">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="pl-13">Information about KoaSocial</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <Link to="/about">
                <Button
