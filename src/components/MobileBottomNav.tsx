  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-t safe-area-bottom">
      <div className="flex items-center justify-around h-16 px-2">
        ...
        <button
          onClick={onCompose}
          className="absolute -top-7 left-1/2 -translate-x-1/2 h-14 w-14 rounded-full koa-gradient text-primary-foreground shadow-lg koa-shadow flex items-center justify-center transition-transform duration-200 active:scale-95 hover:scale-105"
          aria-label="Compose"
        >
